...
export async function fetchEventsByIds(eventIds) {
  ...
  // Haetaan tasks ja event_instances samalla (vältetään N+1 query -ongelma)
...
2. **JOHDANTO** (2-3 kappaletta, luo tunnelmaa ja innostusta. Ensimmäinen kappale luo yleistä tunnelmaa, toisessa ja kolmannessa kappaleessa esitellään lyhyesti nostetut tapahtumat tekstimuodossa - mainitse tapahtumat luontevasti osana tekstiä, ei luettelona. Tyyli on rento ja kutsuva.)
...
Pidä tyyli johdonmukaisena Kirkkopuiston Terassin aiemman viestinnän kanssa - rento, kutsuva ja lähestyttävä.
 ...
 */
export async function saveNewsletterDraft(name, content, eventIds, tone, html) {
